...
def train_source_domain(deep_model, n_res_blocks, batch_size, learning_rate, path_save_network_model, model_dir_, feature_space_dimension, margin_in_loss, loss_type):
    ...
    path_tfrecords_train = 'D:\\Datasets\\Kather_train_triplets\\triplets.tfrecords'
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(latest_epoch+1, num_epoch):
            ...
            for i in range(STEPS_PER_EPOCH_TRAIN):
                ...
                image_anchor_batch_3_channels = image_anchor.reshape((batch_size, 128, 128, 3))
                image_neighbor_batch_3_channels = image_neighbor.reshape((batch_size, 128, 128, 3))
                image_distant_batch_3_channels = image_distant.reshape((batch_size, 128, 128, 3))
