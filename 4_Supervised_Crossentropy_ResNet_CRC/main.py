    ...
    with tf.Session() as sess:
        ...
        for epoch in range(latest_epoch+1, num_epoch):
            ...
            for i in range(STEPS_PER_EPOCH_TRAIN):
                ...
                tissue_type = tissue_type - 1  #--> labels of Kather dataset had started from 1 (in tensorflow)
                ...
                image_batch_3_channels = image_.reshape((batch_size, 128, 128, 3))

                _, loss_v, embedding1 = sess.run([train_step, network_.loss, network_.o1], feed_dict={
                    network_.x1: image_batch_3_channels,
